...
const MenuViewMobile: React.FC<MenuViewProps> = ({ onNavigateRead, themeColor }) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen text-center px-4 relative overflow-hidden bg-app-bg">
            ...
            <header className="mb-10 z-10 flex flex-col items-center mt-12">
                <div className="relative w-36 h-36 mb-6 flex items-center justify-center">
                    ...
                    <div className="relative z-10 p-5 transform hover:scale-110 transition-transform duration-500">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-14 h-14 text-app-accent drop-shadow-[0_0_10px_rgba(var(--app-accent-rgb),0.5)]">
                ...
                <p className="text-base sm:text-lg text-app-textMuted max-w-lg font-light px-4">
                    Không gian đọc truyện cá nhân của bạn. Tải lên, lưu trữ và đắm chìm vào thế giới của những trang sách.
                </p>
            </header>
            
            <div className="max-w-xs w-full z-10 px-4">
