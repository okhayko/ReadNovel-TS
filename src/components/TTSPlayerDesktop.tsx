...
const TTSPlayerDesktop: React.FC<TTSPlayerProps> = ({ content, onIndexChange, currentIndex, isPlaying, setIsPlaying, isPaused, setIsPaused, onEndChapter, settings }) => {
        ...
        <div className="flex flex-col items-center gap-4 p-4 bg-app-surface/50 backdrop-blur-md border border-app-border rounded-2xl mb-8 relative">
            ...
            <div className="flex items-center justify-between w-full gap-4 relative z-10">
                ...
                <div className="flex-1">
                    ...
                    />
                    {isModelLoading && (
                        <div className="text-[10px] text-app-accent animate-pulse mt-2 flex flex-col items-center justify-center w-full">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        className={`w-12 h-12 rounded-full flex items-center justify-center transition-transform shadow-lg ${isModelLoading ? 'bg-app-surface/50 text-app-textMuted cursor-wait' : 'bg-app-accent text-app-bg hover:scale-105 shadow-app-accent/20'
                            }`}
                    >
                        {isModelLoading ? (
            ...
            {isPlaying && (
                <div className="text-[10px] text-app-accent/70 font-medium uppercase tracking-widest animate-pulse flex flex-col items-center">
